...
interface StackEntry {
  ...
  uid: number;
  /** If set, the card enters flying in from this x offset (used by "previous"). */
...
export function CardCarousel({
  ...
  // Notify listeners (and drive ambient glow) when the front card changes.
  React.useEffect(() => {
...
function StackItem({
  ...
  // Fly-in for a "previous" card returning to the front.
  React.useEffect(() => {

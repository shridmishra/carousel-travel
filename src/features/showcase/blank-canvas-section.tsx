      ...
      <div className="relative mx-auto max-w-5xl space-y-16">
        ...
        <header className="flex items-center justify-between border-b border-border pb-6">
          <div className="flex items-center gap-3">
            <div className="flex size-9 items-center justify-center rounded-lg border border-border bg-card text-foreground shadow-xs dark:shadow-inset-rim">
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 rounded-xl border border-border bg-card p-6 shadow-xs dark:shadow-inset-rim sm:grid-cols-3">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <div className="rounded-lg border border-border bg-muted/50 p-4 font-sans text-xs text-foreground dark:shadow-inset-rim">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="group relative flex min-h-[160px] flex-col items-center justify-center rounded-2xl border-2 border-dashed border-wireframe bg-wireframe-subtle/60 p-8 text-center transition-colors hover:border-primary/40">
              <div className="flex items-center gap-2 rounded-full border border-border bg-background px-3 py-1 text-xs font-sans font-semibold uppercase tracking-wider text-muted-foreground shadow-2xs dark:shadow-inset-rim">
